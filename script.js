...
questionNumber.innerText = localStorage.getItem("questionNumber") || "1/25";
let setTimeoutId;
...
function changeQuestion() {
  ...
  // If Timeout Reveal Ans and disable click (setTimeout Purpose)
...
nextButton.addEventListener("click", () => {
  ...
  if (parseInt(questionNumber.innerText) < questions.length) {
    localStorage.setItem(
      "questionNumber",
      `${parseInt(questionNumber.innerText) + 1}/25`
    );
    questionNumber.innerText = localStorage.getItem("questionNumber");
    clearTimeout(setTimeoutId);
    counter = 31;
    index++;
    // ! Local Storage for Index
...
// ! Trying to Save State When User Reloads

// function loadState() {
//   const optionId = localStorage.getItem("selectedOption");
//   const optionIdDiv = document.getElementById(optionId);
//   console.log(optionIdDiv);
//   if (optionIdDiv.innerText == questions[index].correct) {
//     console.log('corr');
//     optionIdDiv.classList.add("correctOption");
//   } else {
//     console.log('wrong');

//     optionIdDiv.classList.add("wrongOption");
//     for (let i = 0; i < options.children.length; i++) {
//       if (options.children[i].innerText === questions[index].correct) {
//         options.children[i].classList.add("revealAns");
//         break;
